...
# The newsroom checks new slugs against these, so a student naming a review
# "Alien" cannot make Josue Reyes's poem unreachable. Kept as its own small file
# because the newsroom should not have to load 160 KB of article bodies to check
# whether a name is free.
open my $S, '>:encoding(UTF-8)', "$root/shared/reserved-slugs.js" or die $!;
print $S "// GENERATED by tools/build-articles.pl — do not edit.\n";
